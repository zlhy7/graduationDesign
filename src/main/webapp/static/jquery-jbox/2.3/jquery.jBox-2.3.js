...
(function (a) {
    a.jBox = function (b, c) {
        ...
        a.each(b, function (N, O) {
            ...
            r.push('<div class="jbox-button-panel" style="text-align: center;' + (P ? '' : 'display:none;') + '">');
            if (!c.isTip) {
    ...
    a.jBox.prompt = function (b, c, d, e) {
        ...
        h.push('<span class="jbox-icon jbox-icon-' + e.icon + '" style="position:absolute; top:' + (f + e.border-10) + 'px;left:' + (0xa + e.border) + 'px; width:32px; height:32px;"></span>');
        h.push(e.content);
        h.push('</div>');
        e.content = h.join('');
        a.jBox(e.content, e)
    ...
    a.jBox.tip = function (b, c, d) {
        ...
        e.push('<span class="jbox-icon jbox-icon-' + d.icon + '" style="position:absolute;top:' + (0x4 + d.border-10) + 'px;left:' + (0x4 + d.border) + 'px; width:32px; height:32px;"></span>');
        e.push(d.content);
        e.push('</div>');
        d.content = e.join('');
    ...
    a.jBox.messager = function (b, c, d, e) {
        ...
        i.push('<span class="jbox-icon jbox-icon-' + e.icon + '" style="position:absolute; top:' + (g + e.border-10) + 'px;left:' + (0xa + e.border) + 'px; width:32px; height:32px;"></span>');
        i.push(e.content);
        i.push('</div>');
        e.content = i.join('');
        a.jBox(e.content, e)
